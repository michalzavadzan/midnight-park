<template>
  <section class="mx-auto px-4 w-11/12">
    <div class="my-10">
      <h1 class="text-4xl md:text-6xl font-bold my-3">Platforms</h1>
    </div>
  </section>
...
import PlatformsCard from '@/components/GridCards/PlatformsCard.vue'
    ...
    watchEffect(() => {
      ...
      const fetchItems = async () => {
        const response = await axios(
          `https://api.rawg.io/api/platforms?key=c0233312e0954f0ca72e3d1e9d64ef32&page=${state.currentPage}&page_size=20`
        )
